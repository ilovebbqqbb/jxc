		...
		<table class="layui-table">
		  ...
		  <tbody>
		    <c:forEach items="${differenceList}" var="difference">
		    	<tr>
		    		<td  onclick="iframeShowPrepareDifference(${difference.differenceId})">${difference.differenceId}</td>
...
function iframeShowPrepareDifference(differenceId){
	layui.use('layer', function(){
		  var layer = layui.layer;
		  var showrul = "<%=basePath%>sell/iframeShowPrepareDifference?differenceId=" + differenceId;
